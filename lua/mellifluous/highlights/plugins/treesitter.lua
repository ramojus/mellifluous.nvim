...
function M.set(hl, colors)
    ...
    hl.set('@debug', { fg = colors.other_keywords.hex })                                             -- Debugging statements.
    ...
    hl.set('@field', { fg = colors.fg.hex, style = config.styles.properties })                       -- Object and struct fields.
    ...
    hl.set('@keyword.function', { fg = colors.main_keywords.hex, style = config.styles.keywords })   -- Keywords used to define a function: `function` in Lua, `def` and `lambda` in Python.
    hl.set('@keyword.operator', { fg = colors.other_keywords.hex, style = config.styles.operators }) -- Unary and binary operators that are English words: `and`, `or` in Python; `sizeof` in C.
    hl.set('@keyword.return', { fg = colors.main_keywords.hex, style = config.styles.keywords })     -- Keywords like `return` and `yield`.
    ...
    hl.set('@parameter', { fg = colors.fg.hex })                                                     -- Parameters of a function.
    ...
    hl.set('@environment', { fg = colors.other_keywords.hex })                                       -- Text environments of markup languages.
    ...
    hl.set('@note', { fg = colors.special_comments.hex })                                            -- Text representation of an informational note.
    hl.set('@warning', { fg = colors.orange.hex })                                                   -- Text representation of a warning note.
    hl.set('@danger', { fg = colors.red.hex })                                                       -- Text representation of a danger note.
    ...
    hl.set('@variable.builtin', { fg = colors.other_keywords.hex })                                  -- Variable names defined by the language: `this` or `self` in Javascript.
end
