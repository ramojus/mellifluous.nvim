...
function M.set(hl, colors)
    ...
    hl.set("BlinkCmpLabelDeprecated", { fg = hl.get("Comment").fg })
    hl.set("BlinkCmpLabelMatch", { fg = colors.fg })
    hl.set("BlinkCmpGhostText", { fg = hl.get("Comment").fg })
    hl.set("BlinkCmpKind", { fg = hl.get("Type").fg })
    hl.set("BlinkCmpKindText", { fg = hl.get("String").fg })
    hl.set("BlinkCmpKindMethod", { fg = hl.get("CmpItemKindFunction").fg })
    ...
    hl.set("BlinkCmpKindProperty", { fg = hl.get("CmpItemKindField").fg })
    hl.set("BlinkCmpKindUnit", { fg = hl.get("CmpItemKindStruct").fg })
    hl.set("BlinkCmpKindValue", { fg = hl.get("CmpItemKindConstant").fg })
    ...
    hl.set("BlinkCmpKindFolder", { fg = hl.get("CmpItemKindFile").fg })
    ...
    hl.set("BlinkCmpDocBorder", { bg = hl.get("NormalFloat").bg })
    hl.set("BlinkCmpDocCursorLine", { bg = hl.get("Visual").bg })
