...
function M.set(hl, colors)
    ...
    if config.is_bg_dark then
        hl.set("GitSignsAdd", { fg = colors.green:with_lightness(55):with_saturation(60), bg = bg })
        hl.set("GitSignsChange", { fg = colors.orange:with_lightness(55):with_saturation(60), bg = bg })
        hl.set("GitSignsDelete", { fg = colors.red:with_lightness(45):with_saturation(70), bg = bg })
    else
